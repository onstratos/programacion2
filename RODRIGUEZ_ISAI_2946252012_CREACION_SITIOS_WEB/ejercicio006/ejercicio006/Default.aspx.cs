...
public partial class _Default : System.Web.UI.Page
{
    ...
    protected void buttonResultado_Click(object sender, EventArgs e)
    {
        ...
        {
            int suma = x1 + x2;
            labelResultado.Text = "La suma de los dos valores es: " + suma + "<br>";
        }
        if (ListBox1.Items[1].Selected)
        {
            int resta = x1 - x2;
            labelResultado.Text += "La diferencia de los dos valores es: " + resta + "<br>";
        }
        if (ListBox1.Items[2].Selected)
        {
            int multi = x1 * x2;
            labelResultado.Text += "El producto de los dos valores es: " + multi + "<br>";
        }
        if (ListBox1.Items[3].Selected)
        {
            int divi = x1 / x2;
            labelResultado.Text += "El cociente de los dos valores es: " + divi + "<br>";
        }
    }
}